...
class Google_Meet_Integration_Google_Calendar {
    ...
    public function __construct() {
        //load resources
        require_once(PLUGINPATH . "Google_Meet_Integration/ThirdParty/google-api-php-client-2-15-0/autoload.php");
    }
    ...
    public function save_event($data = array(), $id = 0, $db = null) {
        if (!$data) {
            return false;
        }
        ...
        $end_date_time = new \DateTime($start_date . " " . $start_time, new \DateTimeZone(get_setting("timezone")));
        $end_date_time->add(new \DateInterval('PT30M'));
        $end_time_object_of_google_calendar = $this->_get_start_end_date_time($end_date_time->format('Y-m-d'), $end_date_time->format('H:i:s'));
        ...
        $event = new \Google_Service_Calendar_Event(array(
            ...
            'end' => $end_time_object_of_google_calendar,
        ...
        $Google_Meet_meetings_model = new \Google_Meet_Integration\Models\Google_Meet_meetings_model($db);
        ...
        try {
            ...
            log_message('error', '[Google Meet Integration] Google Calendar API Error: {exception}', ['exception' => $ex]);
    ...
    private function _get_start_end_date_time($start_date = "", $start_time = "") {
        ...
        $time_array = array("timeZone" => $timezone);
