...
class Google_Docs_Integration_Updates extends Security_Controller {
    ...
    function __construct() {
        ...
        $this->product = "Google_Docs_Integration";
    ...
    function index() {
        ...
        echo $this->template->view("Google_Docs_Integration\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_google_docs_integration_setting("google_docs_integration_item_purchase_code");
