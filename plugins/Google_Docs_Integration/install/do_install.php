...
$product = "Google_Docs_Integration";
...
$sql = str_replace('Google_Docs_Integration-ITEM-PURCHASE-CODE', $item_purchase_code, $sql);
...
$sql_explode = explode('--#', $sql); //persing with --# because there has another #'s 
