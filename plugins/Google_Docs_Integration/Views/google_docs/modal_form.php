        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class=" col-md-9">
                    ...
                    <!--Clients-->
                    <?php if (get_google_docs_integration_setting("client_can_access_google_docs")) { ?>
                        <div class="share-with-section">
                            <div>
                                ...
                                ?>
                                <label for="share_with_all_client_contacts"><?php echo app_lang("google_docs_integration_all_client_contacts"); ?></label>
                            </div>
    ...
    $(document).ready(function () {
        $("#google-docs-form").appForm({
            onSuccess: function (result) {
                if (window.GoogleDocsRefreshPageAfterUpdate) {
                    window.GoogleDocsRefreshPageAfterUpdate = false;
                    location.reload();
                } else {
                    $("#google-docs-table").appTable({newData: result.data, dataId: result.id});
                }
            }
        });
