...
class Google_Sheets_Integration_Updates extends Security_Controller {
    ...
    function __construct() {
        ...
        $this->app_update_url = "https://releases.MHL.com/rise_plugins/";
        $this->product = "Google_Sheets_Integration";
    ...
    function index() {
        ...
        echo $this->template->view("Google_Sheets_Integration\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_google_sheets_integration_setting("google_sheets_integration_item_purchase_code");
    ...
    function do_update($version = "") {
        ...
        $zip = new \ZipArchive;
        $zip->open($this->updates_path . $version . '.zip');
