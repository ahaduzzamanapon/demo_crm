...
class Zoom_Integration_Updates extends Security_Controller {
    ...
    function index() {
        ...
        echo $this->template->view("Zoom_Integration\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_zoom_integration_setting("zoom_integration_item_purchase_code");
