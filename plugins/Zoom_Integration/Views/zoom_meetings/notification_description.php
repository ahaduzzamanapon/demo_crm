...
if ($notification->plugin_zoom_meeting_id) {
    ...
    echo "<div>" . app_lang("zoom_integration_topic") . ": " . $meeting_info->title . "</div>";
    echo "<div>" . app_lang("zoom_integration_meeting_time") . ": " . format_to_datetime($meeting_info->start_time) . "</div>";
}
