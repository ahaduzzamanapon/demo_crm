...
$lang["zoom_meeting"] = "Συνάντηση ζουμ";
$lang["zoom_integration_can_manage_zoom_meetings"] = "Μπορείτε να διαχειριστείτε συσκέψεις Zoom;";
$lang["zoom_integration_client_can_access_zoom_meetings"] = "Ο πελάτης μπορεί να έχει πρόσβαση σε συσκέψεις Zoom;";

$lang["zoom_integration_new_meeting_scheduled"] = "Προγραμματίστηκε νέα συνάντηση";
$lang["notification_zoom_integration_new_meeting_scheduled"] = "Δημιουργήθηκε μια νέα συνάντηση.";

$lang["zoom_integration_meeting_updated"] = "Η σύσκεψη ενημερώθηκε";
$lang["notification_zoom_integration_meeting_updated"] = "Ενημερώθηκε μια συνάντηση.";

/* Version: 1.2 */

$lang["zoom_integration_redirect_url_help_message"] = "Θυμηθείτε να προσθέσετε αυτό το url στην ενότητα URL ανακατεύθυνσης για OAuth και Allow List.";

/* Version: 1.3 */

$lang["zoom_account_id"] = "Αναγνωριστικό λογαριασμού";
