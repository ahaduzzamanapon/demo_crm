...
class Easy_Backup_Updates extends Security_Controller {
    ...
    function index() {
        ...
        echo $this->template->view("Easy_Backup\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_easy_backup_setting("easy_backup_item_purchase_code");
