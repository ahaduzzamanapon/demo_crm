...
class Projects extends Security_Controller
{
    ...
    function save()
    {
        ...
        $data = array(
            ...
            "billable_type" => $this->request->getPost('billable_type') ? $this->request->getPost('billable_type') : "billable",
        );
    ...
    private function _get_headers_for_import()
    {
        ...
        return array(
            ...
            array(
                "name" => "client",
                "custom_validation" => function ($client, $row_data) {
            ...
            array(
                "name" => "status",
                "required" => true,
                "custom_validation" => function ($status, $row_data) {
            ...
            array(
                ...
                "custom_validation" => function ($project_members, $row_data) {
