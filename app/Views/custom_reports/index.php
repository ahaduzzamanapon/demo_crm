                                ...
                                <table class="team-report-table">
                                    ...
                                    <tfoot>
                                        <tr class="total-row">
                                            ...
                                            <td>
                                                <span style="cursor:pointer; color:#1e3a8a; text-decoration:underline;" data-act="ajax-modal" data-action-url="<?php echo get_uri('custom_reports/team_wise_tasks_modal'); ?>" data-post-team_id="<?php echo $team['team_id']; ?>" data-post-project_id="<?php echo $project_id; ?>" data-post-status_id="" data-post-start_date="<?php echo $start_date; ?>" data-post-end_date="<?php echo $end_date; ?>" data-post-type="overall"><?php echo $team['overall_tasks']; ?></span> / 
                                            ...
                                            ?>
                                                <td>
                                                    <span style="cursor:pointer; color:#1e3a8a; text-decoration:underline;" data-act="ajax-modal" data-action-url="<?php echo get_uri('custom_reports/team_wise_tasks_modal'); ?>" data-post-team_id="<?php echo $team['team_id']; ?>" data-post-project_id="<?php echo $project_id; ?>" data-post-status_id="<?php echo $ts->id; ?>" data-post-start_date="<?php echo $start_date; ?>" data-post-end_date="<?php echo $end_date; ?>" data-post-type="overall"><?php echo ($team['overall_status_totals'][$ts->id] ?? 0); ?></span> / 
